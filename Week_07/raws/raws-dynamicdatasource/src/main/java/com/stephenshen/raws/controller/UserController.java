...
public class UserController {
    ...
    public void removeByUserId(@RequestBody User user){
        userService.removeByUserId(user.getUserId());
    }

    @RequestMapping("/modifyByUserId")
    public void modifyByUserId(@RequestBody User user){
